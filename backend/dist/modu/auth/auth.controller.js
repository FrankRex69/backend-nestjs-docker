...
const read_auth_dto_1 = require("./dto/read-auth.dto");
...
__decorate([
    ...
    common_1.Get('getLoginToken'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "getLoginToken", null);
__decorate([
    common_1.Post('checkLoginToken'),
    swagger_1.ApiBearerAuth('access-token'),
    common_1.UseGuards(auth_guard_1.AuthGuard),
    __param(0, common_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [read_auth_dto_1.ReadAuthDto]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "getAccessToken", null);
__decorate([
    common_1.UseGuards(auth_guard_1.AuthGuard),
    common_1.Get('testProfile'),
